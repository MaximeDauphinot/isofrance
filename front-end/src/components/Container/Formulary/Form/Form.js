...
const type = (
    <select className="inputstyle" id="type" name="type" required>
        <option value="00 - Type de surface*">Type de surface*</option>
        <option value="01 - Comble">Comble</option>
        <option value="02 - Garage">Garage</option>
        <option value="03 - Vide sanitaire">Vide sanitaire</option>
    </select>
)
            ...
            <div className="simulator">
                ...
                <div className="alignmentformulary">
                    <form className="form" id="contact-form" onSubmit={this.handleSubmit.bind(this)} method="POST" >
                        <div className="row">
                            <input className="inputstyle" type="text" id="nom" name="nom" placeholder="Nom*" required/>
                            <input className="inputstyle" type="text" id="prenom" name="prenom" placeholder="Prenom*" required/>
                        </div>
                        <div className="row">
                            <input className="inputstyle" type="text" id="email" name="email" placeholder="Email*"  required/>
                            <input className="inputstyle" type="text" id="telephone" name="telephone" placeholder="Numéro de téléphone*" required/>
                       </div>
                       <div className="row">
                            <input className="inputstyle" type="text" id="adresse" name="adresse" placeholder="Adresse*" required/>
                            <input className="inputstyle" type="text" id="ville" name="ville" placeholder="Ville*" required/>
                       </div>
                        <div className="row">
                        <input className="inputstyle" type="text" id="revenu" name="revenu" placeholder="Revenu fiscal €/an *" required/>
                            <input className="inputstyle" type="text" id="nbrpersonne" name="peopleNumber" placeholder="Nbr personnes/foyer*" required/>
                        </div>
                        <div className="row">
                            {/* <input className="inputstyle" type="text" id="type" name="type" placeholder="Type de Surface à isoler*" required/> */}
                            {type}
